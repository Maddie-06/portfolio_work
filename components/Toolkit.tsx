...
const Toolkit: React.FC = () => {
  ...
  return (
    <section className="min-h-screen pt-32 pb-20 px-6 bg-[#030303] relative flex flex-col items-center overflow-hidden">
        {/* Background Grid */}
        ...
        <div className="max-w-7xl mx-auto w-full relative z-10">
            <ScrollReveal>
                <div className="flex flex-col items-center text-center mb-20">
                    ...
                    <h1 className="font-serif text-5xl md:text-7xl text-white mb-6">The <span className="text-lavender italic">Toolkit</span></h1>
