...
const Experience: React.FC = () => {
  return (
    <section id="experience" className="min-h-screen pt-32 pb-24 px-6 bg-[#050505] flex flex-col items-center relative overflow-hidden">
      {/* Background Decor */}
        ...
        <ScrollReveal>
          <div className="text-center mb-24">
             <div className="inline-flex items-center gap-2 border border-white/10 rounded-full px-4 py-1 mb-6 bg-white/5">
                ...
                <span className="font-mono text-[10px] text-gray-300 uppercase tracking-widest">Career Trajectory</span>
             </div>
             <h1 className="font-serif text-5xl md:text-6xl text-white mb-4">Professional <span className="italic text-gray-500">History</span></h1>
             <p className="text-gray-400 font-mono text-sm max-w-lg mx-auto">
               A chronological archive of roles, contributions, and professional growth within the cybersecurity and tech ecosystem.
             </p>
          </div>
        </ScrollReveal>
